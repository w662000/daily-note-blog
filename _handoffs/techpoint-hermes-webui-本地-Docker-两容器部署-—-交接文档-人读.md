---
layout: default
title: 技术点 · hermes-webui 本地 Docker 两容器部署 — 交接文档（人读）
date: 2026-07-21 23:30:00 +0800
---

# 技术点 · hermes-webui 本地 Docker 两容器部署 — 交接文档（人读）

> 来源：260721_hermes-webui本地Docker两容器部署_handoff.md（项目 handoff 1:1 companion，由 techpoint_flow 新方法提炼；读取编码：utf-8）
...
### 关键技术要点（自动抽取）
- **来源**：handoff\bak\260721_hermes-webui本地Docker两容器部署_handoff.md（编码探测：utf-8）
